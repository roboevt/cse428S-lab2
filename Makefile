...
CMPL_SRCS	= Suit.cpp PinochleDeck.cpp HoldEmDeck.cpp main.cpp Game.cpp PinochleGame.cpp HoldEmGame.cpp

#               Source files containing only template class method definitions
TMPL_SRCS	= Card.cpp CardSet.cpp

#               Header (.h) files
HEADER_FILES    = Suit.h Card.h Deck.h PinochleDeck.h HoldEmDeck.h CardSet.h Game.h PinochleGame.h HoldEmGame.h
